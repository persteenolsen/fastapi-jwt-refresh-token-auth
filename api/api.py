...
app = FastAPI(
    ...
    description="08-08-2026 - FastAPI authentication service using JWT and Refresh Token Renewal with PostgreSQL for data persistence and Alembic for database migrations. Demo credentials: testuser / admin",
    version="0.0.1",
