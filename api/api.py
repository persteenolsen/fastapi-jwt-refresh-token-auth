...
app = FastAPI(
    ...
    title="Python + FastApi + PostgreSQL + Alembic and Auth by JWT with Refresh Tokens",
    description="26-01-2026 - FastAPI serving Authentication by JWT with Refresh Tokens using these credentials: testuser / admin",
    version="0.0.1",
